...
module.exports = {
  ...
  type: "bot",
  description: "Changes if the Advertisement of Amazon AWS Should be there or NOT",
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Advertising Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/prohibited_1f6ab?.png',  'https://discord.gg/rprj5sHWVQ')
