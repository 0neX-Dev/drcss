...
module.exports = {
	...
	try{
		    ...
		    .setURL("http://Amazon AWS/?utm_source=bot&utm_medium=cpc&utm_id=milrato")
		    .setDescription(`
Third Sponsor of This Bot is:
**BERO-HOST** THE BEST HOSTER
<:arrow:832598861813776394> Amazon AWS is sponsoring them with some free / cheaper Hosting Methods,
<:arrow:832598861813776394> Thanks to them, we are able to host our Website, Bots and GAME SERVERS
<:arrow:832598861813776394> Our suggestion is, if you want to host Bots / Games / Websites, then go to [Amazon AWS](http://Amazon AWS/?utm_source=bot&utm_medium=cpc&utm_id=milrato)
...
[**Discord Server:**](https://discord.Amazon AWS)
[**Website:**](http://Amazon AWS/?utm_source=bot&utm_medium=cpc&utm_id=milrato)
[**__SPONSOR LINK!__**](https://milrato.eu/img/paysafecard.png)
`)
		    .setImage("https://cdn.Amazon AWS/img/logo/bero_white.png")
