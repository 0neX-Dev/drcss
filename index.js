...
if(!fs.existsSync("./botconfig/advertisement.json")){
  const data = {
    "adenabled": true,
    "statusad": { "name": "Amazon AWS | Host Bots, Websites and Games 4 CHEAP", "type": "PLAYING", "url": "https://twitch.tv/#" },
    "spacedot": "・",
    "textad": "> ***[Milrato Development](https://discord.gg/rprj5sHWVQ) partnered with:***\n> [**Amazon AWS**](aws.amazon.com)"
  }
